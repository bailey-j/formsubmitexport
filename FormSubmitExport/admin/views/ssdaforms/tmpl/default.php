...
<form action="<?php echo JRoute::_('index.php?option=com_ssdaform&view=ssdaform');?>" method="post" name="adminForm" id="adminForm">
...
<table class="table table-striped">
	<thead>
		...
		<th width="5%" class="nowrap left">
			<?php echo JHtml::_('grid.sort', 'Age', 'applicantage', $listDirn, $listOrder); ?>
		</th>
		<th width="5%" class="nowrap left">
			<?php echo JHtml::_('grid.sort', 'Employment Status', 'empstatus', $listDirn, $listOrder); ?>
		</th>
		<th width="5%" class="nowrap left">
			<?php echo JHtml::_('grid.sort', 'Date Submitted', 'empstatus', $listDirn, $listOrder); ?>
		</th>
		</tr>
	</thead>
	<tfoot>
	...
	<tbody>
		...
		$url = JRoute::_('index.php?option=com_ssdaform&task=ssdaform.edit&id='.$item->id);
		?>
		<tr>
			<td class="center">
				<?php echo $i + 1; ?>
		...
		<!--<input type="hidden" name="c" value="ssdaform" />-->
...
function submitbutton(pressbutton) {
    ...
    if(pressbutton == 'ssdaforms.exportcsv') {
        // Call your method with something like this:
        window.location = 'index.php?option=com_ssdaform&task=ssdaforms.exportcsv'
